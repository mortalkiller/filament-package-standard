...
- exact prompt;
- raw response or durable link/file;
- observed baseline failures;
- observed with-skill improvements;
- date.

Do not replace this requirement with a self-review from the same agent that writes the skill.
